...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "ecfdbfad535391cb0512";
...
async function render(req, res) {
  ...
  if (activeRoute && activeRoute.component.fetchData) {
    ...
    initialData = await activeRoute.component.fetchData(match, search, null, req.headers.cookie);
  }
...
if (enableHMR && "development" !== 'production') {
  ...
  const hotMiddleware = __webpack_require__(/*! webpack-hot-middleware */ "webpack-hot-middleware"); // Modify config.
  ...
  config.plugins.push(new webpack.HotModuleReplacementPlugin()); // Add middlewares.
...
if (apiProxyTarget) {
  ...
  app.use('/auth', http_proxy_middleware__WEBPACK_IMPORTED_MODULE_1___default()({
    target: apiProxyTarget
  }));
} // API endpoint setup.
...
app.get('*', (req, res, next) => Object(_render_jsx__WEBPACK_IMPORTED_MODULE_4__["default"])(req, res, next));
app.listen(port, () => {
...
function IssueDetail({
  ...
  if (issue) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3", null, "Issue Details"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("pre", null, issue.description));
  }
...
class IssueEdit extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  ...
  render() {
    ...
    } = this.props; // Checking for non-existent data.
...
class IssueReport extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  static async fetchData(match, search, showError) {
    const params = new url_search_params__WEBPACK_IMPORTED_MODULE_2___default.a(search);
  ...
  render() {
    ...
    const statRows = stats.map(counts => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tr", {
      ...
      key: status
    }, counts[status])), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", null, Object.keys(counts).reduce((acc, key) => {
      if (key === 'owner') return acc;
      const newTotal = acc + counts[key];
      return newTotal;
    }, 0)))); // Column total calculation.

    const colTotalsInitObject = statuses.reduce((acc, status) => ({ ...acc,
      [status]: 0
    }), {});
    ...
    const totalCol = statuses.map(status => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", {
      key: status
    }, colTotals[status]));
    const {
      location: {
...
class IssueRowPlain extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  render() {
    const {
      issue,
      location: {
...
function NavBar({
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_1__["Navbar"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_1__["Navbar"].Header, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_1__["Navbar"].Brand, null, "Issue Tracker")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_1__["Nav"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_bootstrap__WEBPACK_IMPORTED_MODULE_2__["LinkContainer"], {
    ...
    to: "/about"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_1__["NavItem"], null, "About"))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_1__["Col"], {
    sm: 5
    ...
    pullRight: true
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_IssueAddNavItem_jsx__WEBPACK_IMPORTED_MODULE_5__["default"], {
    user: user
...
class Page extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  static async fetchData(cookie) {
    ...
    const data = await Object(_graphQLFetch_js__WEBPACK_IMPORTED_MODULE_4__["default"])(query, null, null, cookie);
    return data;
  }
...
class Search extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  ...
  async loadOptions(term) {
    ...
    return data.issueList.issues.map(({
      id,
      title
    }) => ({
      label: `#${id}: ${title}`,
