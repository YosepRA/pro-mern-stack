...
var element = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_4__["BrowserRouter"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_src_Page_jsx__WEBPACK_IMPORTED_MODULE_5__["default"], null));
react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(element, document.getElementById('content'));
...
function About() {
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3", null, "Issue Tracker 0.9"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h4", null, "API version 1.0"));
}
...
var DateInput = /*#__PURE__*/function (_Component) {
  ...
  _createClass(DateInput, [{
    ...
    value: function render() {
      ...
      var displayValue = focused || !valid ? value : displayFormat(originalValue);
...
var IssueAddNavItem = /*#__PURE__*/function (_Component) {
  ...
  _createClass(IssueAddNavItem, [{
    ...
    value: function render() {
      var _this$state = this.state,
          ...
          toastVissible = _this$state.toastVissible,
...
var IssueDetail = /*#__PURE__*/function (_Component) {
  _inherits(IssueDetail, _Component);
...
var IssueEdit = /*#__PURE__*/function (_Component) {
  _inherits(IssueEdit, _Component);
  ...
  _createClass(IssueEdit, [{
    ...
    value: function onValidityChange(_ref, valid) {
    ...
    key: "handleChange",
    value: function handleChange(event, naturalValue) {
    ...
    value: function render() {
      ...
      var propsID = this.props.match.params.id; // Checking for non-existent data.
      ...
      var _this$state3 = this.state,
          _this$state3$issue = _this$state3.issue,
          title = _this$state3$issue.title,
          status = _this$state3$issue.status,
          owner = _this$state3$issue.owner,
          effort = _this$state3$issue.effort,
          description = _this$state3$issue.description,
          created = _this$state3$issue.created,
          due = _this$state3$issue.due,
...
var IssueFilter = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(IssueFilter, [{
    ...
    key: "onChangeStatus",
    value: function onChangeStatus(_ref2) {
      var value = _ref2.target.value;
      this.setState({
        status: value,
        changed: true
    ...
    value: function onChangeEffortMin(_ref3) {
      var effortValue = _ref3.target.value;

      if (effortValue.match(/^\d*$/)) {
        this.setState({
          effortMin: effortValue,
          changed: true
        });
      }
    }
    ...
    value: function onChangeEffortMax(_ref4) {
      var effortValue = _ref4.target.value;

      if (effortValue.match(/^\d*$/)) {
        this.setState({
          effortMax: effortValue,
          changed: true
        });
      }
    }
    ...
    value: function render() {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_3__["Row"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_3__["Col"], {
        ...
        bsSize: "small"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_3__["ControlLabel"], null, "Status:"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_3__["FormControl"], {
        componentClass: "select",
...
var IssueList = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(IssueList, [{
    ...
    value: function componentDidUpdate(prevProps) {
      var prevSearch = prevProps.location.search;
      var search = this.props.location.search; // Comparing previous search value with the current one, and only refresh if they're different.
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                if (params.get('status')) vars.status = params.get('status'); // Effort range filter.
              ...
              case 6:
                ...
                if (data && data.issueDelete) {
                  this.setState(function (prevState) {
                    ...
                    return {
                      issues: prevState.issues.filter(function (issue) {
                        return issue.id !== id;
                      })
                    };
                  }, function () {
                    return _this2.showSuccess("Deleted issue ".concat(id, " successfully."));
                  });
                } else {
                  this.loadData();
                }
...
function IssueReport() {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2", null, "IssueReport placeholder."));
}
...
var NumInput = /*#__PURE__*/function (_Component) {
...
function NavBar() {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_1__["Navbar"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_1__["Navbar"].Header, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_1__["Navbar"].Brand, null, "Issue Tracker")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_1__["Nav"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_bootstrap__WEBPACK_IMPORTED_MODULE_2__["LinkContainer"], {
    ...
    to: "/issues"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_1__["NavItem"], null, "List")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_bootstrap__WEBPACK_IMPORTED_MODULE_2__["LinkContainer"], {
    to: "/report"
    ...
    to: "/about"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_1__["NavItem"], null, "About"))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_1__["Nav"], {
    pullRight: true
...
function Footer() {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("small", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("hr", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", {
    ...
    href: "https://github.com/YosepRA/pro-mern-stack"
  }, "GitHub repository.")));
}
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 2;
            _context.next = 5;
            return fetch("".concat(window.ENV.UI_API_ENDPOINT, "/graphql"), {
              method: 'POST',
              headers: {
